...
/*
 * scullv.h -- definitions for the vmalloc char module
 *
 *********/
...
#define SCULLV_IOCSQSET    _IOW(SCULLV_IOC_MAGIC,  2, scullv_qset)
#define SCULLV_IOCTORDER   _IO(SCULLV_IOC_MAGIC,   3)
#define SCULLV_IOCTQSET    _IO(SCULLV_IOC_MAGIC,   4)
#define SCULLV_IOCGORDER   _IOR(SCULLV_IOC_MAGIC,  5, scullv_order)
#define SCULLV_IOCGQSET    _IOR(SCULLV_IOC_MAGIC,  6, scullv_qset)
#define SCULLV_IOCQORDER   _IO(SCULLV_IOC_MAGIC,   7)
#define SCULLV_IOCQQSET    _IO(SCULLV_IOC_MAGIC,   8)
#define SCULLV_IOCXORDER   _IOWR(SCULLV_IOC_MAGIC, 9, scullv_order)
#define SCULLV_IOCXQSET    _IOWR(SCULLV_IOC_MAGIC,10, scullv_qset)
