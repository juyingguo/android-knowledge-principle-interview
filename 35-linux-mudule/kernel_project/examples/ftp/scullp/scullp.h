/*
 * scullp.h -- definitions for the page-oriented char module
 *
 *********/
...
#define SCULLP_IOCSQSET    _IOW(SCULLP_IOC_MAGIC,  2, scullp_qset)
#define SCULLP_IOCTORDER   _IO(SCULLP_IOC_MAGIC,   3)
#define SCULLP_IOCTQSET    _IO(SCULLP_IOC_MAGIC,   4)
#define SCULLP_IOCGORDER   _IOR(SCULLP_IOC_MAGIC,  5, scullp_order)
#define SCULLP_IOCGQSET    _IOR(SCULLP_IOC_MAGIC,  6, scullp_qset)
#define SCULLP_IOCQORDER   _IO(SCULLP_IOC_MAGIC,   7)
#define SCULLP_IOCQQSET    _IO(SCULLP_IOC_MAGIC,   8)
#define SCULLP_IOCXORDER   _IOWR(SCULLP_IOC_MAGIC, 9, scullp_order)
#define SCULLP_IOCXQSET    _IOWR(SCULLP_IOC_MAGIC,10, scullp_qset)
